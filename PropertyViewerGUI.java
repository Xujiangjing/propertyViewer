...
public class PropertyViewerGUI
{
    ...
    /**
     * Called when the 'statistic' botton was clicked.
     */
    private void statisticsButton(){
        ...
        JTextField numberOfPropertiesViewed = new JTextField(String.valueOf(viewer.getNumberOfPropertiesViewed()));
        numberOfPropertiesViewed.setEditable(false);
        propertyPanel.add(numberOfPropertiesViewed);
        
        propertyPanel.add(new JLabel("Average Property Price: "));
        JTextField averagePropertyPrice = new JTextField(String.valueOf(viewer. averagePropertyPrice()));
        averagePropertyPrice.setEditable(false);
        propertyPanel.add(averagePropertyPrice);
